...
exports.signup = (req, res) => {
    ...
    const { email, firstname, lastname, password, contact_no, pincode } = req.body;
    if (!email || !firstname || !lastname || !password || !contact_no) {
    ...
    User.findOne({ email: email }).then((use) => {
        ...
        const user = new User({ email, firstname, lastname, password, contact_no, pincode, role })
...
exports.signin = (req, res) => {
    ...
    User.findOne({ email: email }).populate("allocatedEvent").exec((err, user) => {
        ...
        const { _id, firstname, lastname, email, role, allocatedEvent, contact_no, events, oxygen } = user;
        return res.json({ token, user: { _id, firstname, lastname, email, role, contact_no, oxygen } });
    })
